// All project case studies. `featured` (1, 2, 3…) places a project in the
// large case-study stack on the homepage, in that order; the rest appear in
// the compact "More work" index. The case-study pages' prev/next chain
// follows the same order (featured first), looping at the end.
//
// Screenshots are served from the responsive set in lib/images.js, keyed
// `work/<slug>`. `tech` and `timeline` are left empty wherever they
// haven't been confirmed — the templates hide empty fields rather than
// showing invented values.
export const caseStudies = [
  {
    slug: "rv-organica",
    oneLiner: "A botanical storefront redesign with a clear bulk-order path.",
    role: "Redesign concept · UX & visual design",
    outcome: "Interactive demo live",
    featured: 6,
  ...
  },
  {
    ...
    oneLiner: "A mission-first website for a humanitarian foundation.",
    role: "Design & development",
    outcome: "Live at rainbowdhammafoundation.org",
  ...
  {
    slug: "vibegifts",
    oneLiner: "An online gift store built for fast, confident checkout.",
    role: "Design & development",
    outcome: "Live at vibegifts.in",
    featured: 8,
    title: "VibeGifts",
  ...
  {
    slug: "astorea",
    oneLiner: "A premium brand site for a construction-materials manufacturer.",
    role: "Design & development",
    outcome: "Live at astorea.in",
    featured: 7,
    title: "Astorea",
  ...
  },
  {
    ...
    oneLiner: "A catalogue-first manufacturer site for dealers and bulk buyers.",
    role: "Design & development",
    outcome: "Live at hindustanwatersolution.in",
    featured: 3,
  ...
  {
    slug: "bavanya",
    oneLiner: "An engineering-led manufacturer site for enterprise buyers.",
    role: "Design & development",
    outcome: "Live at bavanya.co.in",
    featured: 2,
    title: "Bavanya",
  ...
  },
  {
    ...
    oneLiner: "A notice-first information hub for a government school.",
    role: "Design & development",
    outcome: "Live at normalschoolsootea.org.in",
  ...
  {
    slug: "outfyle",
    oneLiner: "A minimal, photo-led storefront for a custom apparel brand.",
    role: "Design & development",
    outcome: "Live at outfyle.com",
    title: "Outfyle",
  ...
  },
  {
    ...
    oneLiner: "A recruitment landing page for Punjab's first AI school.",
    role: "Co-founder · design & development",
    outcome: "Live and taking registrations",
    featured: 5,
  ...
  {
    slug: "nyayadarpan-ai",
    oneLiner: "An AI legal assistant that makes Indian law understandable.",
    role: "Software engineer, founding team",
    outcome: "Public platform live at nyayadarpanai.com",
    featured: 4,
  ...
  {
    slug: "rabal",
    oneLiner: "A B2B fruit marketplace app connecting local farms to bulk buyers.",
  ...
  },
  {
    ...
    oneLiner: "Ongoing administration for a growing K-12 school website.",
    role: "Website administrator",
    outcome: "Ongoing — kept current through the school year",
...
// Featured projects first (by `featured` rank), then everything else in
// file order.
export const orderedCaseStudies = [
  ...caseStudies.filter((c) => c.featured).sort((a, b) => a.featured - b.featured),
