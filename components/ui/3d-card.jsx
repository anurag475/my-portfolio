...
// Aceternity UI's "3D Card" — a perspective/tilt hover effect driven by
// plain mouse-position math and CSS transforms (no animation library
// needed). Ported to plain JSX for this JS/Next.js project: no TypeScript,
// and CardItem's `as` prop stays a plain string/tag instead of a generic.
